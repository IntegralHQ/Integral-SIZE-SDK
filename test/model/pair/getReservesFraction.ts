...
describe('Pair.getDepositReservesFraction', () => {
  ...
  it('limits to upperLimit', () => {
    ...
    expect(pairAB.getDepositReservesFraction(firstTokenPrice, basicTokenPrice)).to.deep.eq(parseUnits('0.99', 20))
  })
  ...
  it('limits to lowerLimit', () => {
    ...
    expect(pairAB.getDepositReservesFraction(firstTokenPrice, basicTokenPrice)).to.deep.eq(parseUnits('1', 16))
  })
