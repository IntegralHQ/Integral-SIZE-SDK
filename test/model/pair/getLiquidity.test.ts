...
describe('Pair.getLiquidity', () => {
  ...
  describe('getLiquidity proportionally', () => {
    describe('ordered', () => {
      const testCases = [
        { description: 'amounts proportional to reserves', amount0: '1', amount1: '2', expected: '1' },
        { description: 'amounts unproportional to reserves', amount0: '1', amount1: '3', expected: '1' },
    ...
    describe('inverted', () => {
      const testCases = [
        { description: 'amounts proportional to reserves', amount0: '2', amount1: '1', expected: '1' },
        { description: 'amounts unproportional to reserves', amount0: '3', amount1: '1', expected: '1' },
